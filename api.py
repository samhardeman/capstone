...
def addImageToDB(camera_id, timestamp, location, numPeople) :
    ...
    for building in buildings:
        ...
        for camera in cameras:
            ...
            try: 
                ...
                imageInformation = addImageToDB(camera_id=camera['id'], timestamp=timeString, location=camera['description'], numPeople=people_count)
